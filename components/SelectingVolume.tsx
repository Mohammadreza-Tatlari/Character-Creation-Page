  ...
  return (
    <div className="w-[440px] h-[62px] overflow-hidden shrink-0 flex flex-col items-start justify-start py-0 pr-0 pl-px box-border gap-[1px_0px]">
      ...
      <div className="self-stretch flex flex-row items-start justify-start gap-[0px_3px] max-w-full text-base font-gilroy-semibold">
        ...
        className="disabled:opacity-25 cursor-pointer rounded-tl-8xs rounded-tr-none rounded-br-none rounded-bl-8xs bg-gray-400 hover:bg-lawngreen-200 active:bg-lawngreen-100/70 group flex flex-row items-center justify-center p-2.5 ">
          <img
        ...
        className="disabled:opacity-25 cursor-pointer rounded-tr-8xs rounded-tl-none rounded-bl-none rounded-br-8xs bg-gray-400 hover:bg-lawngreen-200 active:bg-lawngreen-100/70 group flex flex-row items-center justify-center p-2.5 ">
          <img
            className="h-5 w-5 relative object-contain z-[1]"
            loading="eager"
            alt=""
